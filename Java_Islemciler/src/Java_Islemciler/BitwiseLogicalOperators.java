package Java_Islemciler;

public class BitwiseLogicalOperators {
    public static void main(String[] args) {

        int i = 4; // 0100 2'li tabandaki değeri
        int j = 8; // 1000 2'li tabandaki değeri
        ...
        long u = 6; // 0110 2'li tabandaki değeri
        long v = 2; // 0010 2'li tabandaki değeri
		//int w = u & v;
		//int w = (int) (u & v);
        long w = u & v;

...
//		j = true; // var tür çıkarımı sağlar, etkinleştiren bir şey değildir


        var d = new Date();
        System.out.println("Date: " + d);

//		var anArray = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024};  // Problem! zinin açık bir hedef türüne ihtiyacı var
